...
int test_svb12_nosimd(const int16_t *sigs, const uint32_t nr_sigs,
		      struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = svb12_nosimd_bound(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	/* decompress sigs_press */
	before = clock();
	svb12_nosimd_depress(sigs_press, nr_sigs, sigs_depress);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_svb12_zd_nosimd(const int16_t *sigs, const uint32_t nr_sigs,
			 struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = svb12_zd_nosimd_bound(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	/* decompress sigs_press */
	before = clock();
	svb12_zd_nosimd_depress(sigs_press, nr_sigs, sigs_depress,
				&depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_svb12_zd(const int16_t *sigs, const uint32_t nr_sigs,
		  struct result *res)
{
	clock_t after;
	clock_t before;
...
int test_vbbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
		   struct result * res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = vbbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	vbbe21_zd_depress_16(sigs_press, press_len, sigs_depress, &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(depress_len == nr_sigs);
...
int test_vbsbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
		    struct result * res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = vbsbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	vbsbe21_zd_depress_16(sigs_press, press_len, sigs_depress,
			      &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(depress_len == nr_sigs);
...
int test_vbsse21_zd(const int16_t *sigs, const uint32_t nr_sigs,
		    struct result * res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = vbsse21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	vbsse21_zd_depress_16(sigs_press, press_len, sigs_depress,
			      &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(depress_len == nr_sigs);
...
int test_zstd_vbbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = zstd_vbbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	ret = zstd_vbbe21_zd_depress_16(sigs_press, press_len, sigs_depress,
					&depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
...
int test_zstd_vbsbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			 struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = zstd_vbsbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	ret = zstd_vbsbe21_zd_depress_16(sigs_press, press_len, sigs_depress,
					 &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
...
int test_zstd_vbsse21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			 struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = zstd_vbsse21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	ret = zstd_vbsse21_zd_depress_16(sigs_press, press_len, sigs_depress,
					 &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
...
int test_zlib_vbbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = zlib_vbbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	ret = zlib_vbbe21_zd_depress_16(sigs_press, press_len, sigs_depress,
					&depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
...
int test_zlib_vbsbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			 struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = zlib_vbsbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	ret = zlib_vbsbe21_zd_depress_16(sigs_press, press_len, sigs_depress,
					 &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
...
int test_zlib_vbsse21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			 struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = zlib_vbsse21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	ret = zlib_vbsse21_zd_depress_16(sigs_press, press_len, sigs_depress,
					 &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
...
int test_huffman_vbsbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			    struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = huffman_vbsbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	ret = huffman_vbsbe21_zd_depress_16(sigs_press, press_len, sigs_depress,
					    &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
...
int test_huffman_vbsse21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			    struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = huffman_vbsse21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	ret = huffman_vbsse21_zd_depress_16(sigs_press, press_len, sigs_depress,
					    &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
...
int test_shuffman_vbsbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			     struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = shuffman_vbsbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	ret = shuffman_vbsbe21_zd_depress_16(root, sigs_press, press_len,
					     sigs_depress, &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
...
int test_shuffman_vbsse21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			     struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = shuffman_vbsse21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	ret = shuffman_vbsse21_zd_depress_16(root, sigs_press, press_len,
					     sigs_depress, &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
...
int test_rice_vbsbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			 struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rice_vbsbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rice_vbsbe21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				   &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rice_vbsse21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			 struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rice_vbsse21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rice_vbsse21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				   &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rc_zd(const int16_t *sigs, const uint32_t nr_sigs, struct result *res)
{
	clock_t after;
	clock_t before;
	int16_t *sigs_depress;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rc_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rc_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
			       &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rcc_vbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
		      struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rcc_vbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rcc_vbe21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				&depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rccm_vbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
		       struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rccm_vbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rccm_vbe21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				 &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rccm_svb_zd(const int16_t *sigs, const uint32_t nr_sigs,
		     struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rccm_svb_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rccm_svb_zd_depress_16(sigs_press, nr_sigs, sigs_depress, &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rccm_svb12_zd(const int16_t *sigs, const uint32_t nr_sigs,
		       struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rccm_svb12_zd_bound(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rccm_svb12_zd_depress(sigs_press, nr_sigs, sigs_depress, &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rc_vbsbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
		       struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rc_vbsbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rc_vbsbe21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				 &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rc_vbsse21_zd(const int16_t *sigs, const uint32_t nr_sigs,
		       struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rc_vbsse21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rc_vbsse21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				 &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rcc_vbbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
		     struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rcc_vbbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rcc_vbbe21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				 &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rcc_vbsbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rcc_vbsbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rcc_vbsbe21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				  &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rcc_vbsse21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rcc_vbsse21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rcc_vbsse21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				  &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rccm_vbbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rccm_vbbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rccm_vbbe21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				  &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rccm_vbsbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			 struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rccm_vbsbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rccm_vbsbe21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				   &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rccm_vbsse21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			 struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rccm_vbsse21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rccm_vbsse21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				   &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rccdf_vbsbe21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			  struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rccdf_vbsbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rccdf_vbsbe21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				    &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_rccdf_vbsse21_zd(const int16_t *sigs, const uint32_t nr_sigs,
			  struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rccdf_vbsse21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rccdf_vbsse21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				    &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
			 ...
			 struct result *res)
{
	...
	/* bound sigs_press */
	before = clock();
	pressbound = rccm_svbbe21_zd_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	rccm_svbbe21_zd_depress_16(sigs_press, nr_sigs, sigs_depress,
				   &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_dstall_fz_1500(const int16_t *sigs, const uint32_t nr_sigs,
			 struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = dstall_fz_1500_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	dstall_fz_1500_depress_16(sigs_press, nr_sigs, sigs_depress,
				  &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_dstall_fz(const int16_t *sigs, const uint32_t nr_sigs,
		   struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = dstall_fz_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	depress_len = nr_sigs;
	before = clock();
	dstall_fz_depress_16(sigs_press, nr_sigs, sigs_depress, &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
...
int test_hasgam_vbsse21_zdq(const int16_t *sigs, const uint32_t nr_sigs,
			    struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = hasgam_vbsse21_zdq_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	press_len = pressbound;
	before = clock();
	ret = hasgam_vbsse21_zdq_press_16(sigs, nr_sigs, sigs_press,
					  &press_len);
	after = clock();
	UPDATE_RES(res, press_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
	...
	depress_len = nr_sigs;
	before = clock();
	ret = hasgam_vbsse21_zdq_depress_16(sigs_press, press_len, sigs_depress,
					    &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
...
int test_zlib_hasgam_vbsse21_zdq(const int16_t *sigs, const uint32_t nr_sigs,
				 struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = zlib_hasgam_vbsse21_zdq_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	press_len = pressbound;
	before = clock();
	ret = zlib_hasgam_vbsse21_zdq_press_16(sigs, nr_sigs, sigs_press,
					       &press_len);
	after = clock();
	UPDATE_RES(res, press_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
	...
	depress_len = nr_sigs;
	before = clock();
	ret = zlib_hasgam_vbsse21_zdq_depress_16(sigs_press, press_len,
						 sigs_depress, &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
...
int test_zstd_hasgam_vbsse21_zdq(const int16_t *sigs, const uint32_t nr_sigs,
				 struct result *res)
{
	clock_t after;
	clock_t before;
	...
	/* bound sigs_press */
	before = clock();
	pressbound = zstd_hasgam_vbsse21_zdq_bound_16(nr_sigs);
	after = clock();
	UPDATE_RES(res, pressbound_clocktime, GET_CLOCK_SECS(before, after));
	...
	press_len = pressbound;
	before = clock();
	ret = zstd_hasgam_vbsse21_zdq_press_16(sigs, nr_sigs, sigs_press,
					       &press_len);
	after = clock();
	UPDATE_RES(res, press_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
	...
	depress_len = nr_sigs;
	before = clock();
	ret = zstd_hasgam_vbsse21_zdq_depress_16(sigs_press, press_len,
						 sigs_depress, &depress_len);
	after = clock();
	UPDATE_RES(res, depress_clocktime, GET_CLOCK_SECS(before, after));
	ASSERT(ret == 0);
...
int main(int argc, char **argv)
{
	...
	TEST(vbsbe21_zd, &res, fp);
	TEST(vbsse21_zd, &res, fp);
	TEST(zstd_vb1e2_zd, &res, fp);
	TEST(zstd_vbe21_zd, &res, fp);
	TEST(zlib_vbe21_zd, &res, fp);
	TEST(zstd_vbbe21_zd, &res, fp);
	TEST(zlib_vbbe21_zd, &res, fp);
	TEST(zstd_vbsbe21_zd, &res, fp);
	TEST(zlib_vbsbe21_zd, &res, fp);
	TEST(zstd_vbsse21_zd, &res, fp);
	TEST(zlib_vbsse21_zd, &res, fp);
