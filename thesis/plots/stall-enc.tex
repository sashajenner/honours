...
starting position in the read, length, compressed size and compressed data.
	Followed by the non-stall's compressed size and compressed data is
	recorded. The specific and generic compression algorithms used are known
	beforehand and hence are not stored. stall-fz uses rc-vbbe21-for and
	rc-vbbe21-zd as the specific and generic algorithm respectively.}
\end{figure}
